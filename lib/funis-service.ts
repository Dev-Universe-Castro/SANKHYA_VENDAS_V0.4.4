...
export async function consultarFunis(codUsuario?: number, isAdmin: boolean = false): Promise<Funil[]> {
  ...
  try {
    ...
    return mapearEntidades(respostaFunis.responseBody.entities, 'CODFUNIL') as Funil[];
  } catch (erro) {
